    ...
    <div class="total-container">
        <div class="careseeker-profile-container">
            ...
            <img src="https://t3.ftcdn.net/jpg/02/00/90/24/360_F_200902415_G4eZ9Ok3Ypd4SZZKjc8nqJyFVp1eOD6V.jpg" alt="Profile Picture" />   
                <div>
                    <h4>Jerome Bell</h4>
                   <span class="tag accepted">Specialist</span>
                </div>
                <button class="view-profile-btn" onclick="window.location.href='<?php echo URLROOT; ?>/consultant/consultantprofile'">View Profile</button>
            ...
            <div class="profile-card">
                ...
                <div>
                    <h4>Jerome Bell</h4>
                    <span class="tag completed">Therapist</span>
                </div>
                <button class="view-profile-btn" onclick="window.location.href='<?php echo URLROOT; ?>/consultant/consultantprofile'">View Profile</button>
            </div>
