...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/css/consultant/paymentMethodnew.css">
        ...
        <div class="view-requests-m-c-r-table-container">
            ...
            <div id="viewMode" class="<?php echo $data['edit_mode'] ? 'hidden' : ''; ?>">
                ...
                <div class="editbutton">
                    ...
                    <form action="<?php echo URLROOT; ?>/consultant/deletePayMethod" method="post" style="display:inline;">
            ...
            <!-- Edit Mode -->
            <form id="editMode" action="<?php echo URLROOT; ?>/consultant/updatePayMethod" method="post" class="<?php echo !$data['edit_mode'] ? 'hidden' : ''; ?>">
                <div class="form-section">
                    <h3>Contact Information</h3>
