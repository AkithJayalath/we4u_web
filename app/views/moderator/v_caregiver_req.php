    ...
    <div class="request-content">
      ...
      <div class="request-table-container">
        ...
        <div class="request-info-grid">
          ...
          <div class="request-info-card">
            ...
            <div class="info-value"><?php echo $data['caregiver']->contact_info; ?></div>
          </div>
          <div class="request-info-card">
            <div class="info-label">NIC</div>
            <div class="info-value"><?php echo $data['caregiver']->national_id; ?></div>
          </div>
          <div class="request-info-card">
            <div class="info-label">Address</div>
            <div class="info-value"><?php echo $data['caregiver']->address; ?></div>
          </div>
          <div class="request-info-card">
            <div class="info-label">Care Giving Type</div>
            <div class="info-value"><?php echo $data['caregiver']->caregiver_type; ?></div>
          </div>
          <div class="request-info-card">
            <div class="info-label">Years Of Experience</div>
            <div class="info-value"><?php echo $data['caregiver']->years_of_experience; ?></div>
          </div>
          <div class="request-info-card">
            <div class="info-label">Special Skills</div>
            <div class="info-value"><?php echo $data['caregiver']->skills; ?></div>
          </div>
        </div>
      </div>
        ...
        <div class="documents-grid">
          ...
          <div class="document-card">
            ...
            <div class="document-info">
              <div class="document-title"><?php echo $document->document_type; ?></div>
      ...
      <div class="action-buttons">
        <button class="reject-btn" onclick="rejectApplication(<?php echo $data['request']->request_id; ?>)" 
                <?php echo ($data['request']->status !== 'Pending') ? 'disabled' : ''; ?>>
