...
<page-body-container>
    ...
    <!-- m-i-d means moderator individual details -->
    <div class="m-i-d-main-container">
        <div class="m-i-d-profile-header">
            ...
            <div class="m-i-d-status">
                <span class="m-i-d-status-badge"><?php echo $data['request']->status; ?></span>
            </div>
        </div>
                    ...
                    <div class="m-i-d-doc-card">
                        ...
                        <div class="m-i-d-doc-info">
                            ...
                            <div class="m-i-d-doc-actions">
                                <button class="m-i-d-view-btn" >
                                    <i class="fas fa-eye"></i> View
                                </button>
                                <button class="m-i-d-download-btn" >
    ...
    <div id="rejectModal" class="m-i-d-modal">
        <div class="m-i-d-modal-content">
            <h2>Confirm Rejection</h2>
            <p>Are you sure you want to reject this application?</p>
            <div class="m-i-d-modal-buttons">
                <button class="m-i-d-modal-btn m-i-d-confirm-btn" onclick="proceedToRejectForm()">Yes, Proceed</button>
                <button class="m-i-d-modal-btn m-i-d-cancel-btn" onclick="closeModal()">Cancel</button>
            </div>
        </div>
    </div>
    ...
    function proceedToRejectForm() {
        const requestId = document.querySelector('.m-i-d-application-id').textContent.split(':')[1].trim();
