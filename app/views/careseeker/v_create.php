            ...
            <div class="form-section">
                ...
                <div class="form-validation">
                    ...
                    <div class="form-column">
                        ...
                        <input type="text" id="bloodPressure" name="blood_pressure" placeholder="e.g., 120/80 mmHg" required>
                        

                        <label for="emergencyContact">Emergency Contact:</label>
                        <input type="text" id="emergencyContact" name="emergency_contact" placeholder="Enter valid contact" required>
                        <span class="form-invalid"><?php echo $data['emergency_contact_err']; ?></span>

                        <label for="chronicDiseases">Chronic Diseases:</label>
                        <textarea id="chronicDiseases" name="chronic_disease" rows="3" placeholder="List chronic illnesses, if any..."></textarea>
                    ...
                    <div class="form-column">
                        ...
                        <textarea id="currentHealthConcerns" name="current_health_issues" rows="3" placeholder="Describe ongoing issues..."></textarea>
                        
                        <label for="surgeries">Past Surgeries:</label>
                        <textarea id="surgeries" name="surgical_history" rows="3" placeholder="List surgeries, if any..."></textarea>

                        <label for="familyDiseases">Family Diseases:</label>
                        <textarea id="familyDiseases" name="family_diseases" rows="3" placeholder="List hereditary diseases, if any..."></textarea>

                        <label for="currentMedications">Current Medications:</label>
                        <textarea id="currentMedications" name="current_medications" rows="3" placeholder="medication - disease, if any..."></textarea>
                    </div>
                    ...
                    <div class="form-column">
                        ...
                        <textarea id="specialNeeds" name="special_needs" rows="3" placeholder="List special needs, if any..."></textarea>
                        
                        <label for="dietaryRestrictions">Dietary Restrictions:</label>
                        <textarea id="dietaryRestrictions" name="dietary_restrictions" rows="3" placeholder="List dietary restrictions, if any..."></textarea>
                    </div>
