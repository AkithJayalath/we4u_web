    ...
    <div class="main-container">
      <div class="form-container">
        ...
        <form action="<?php echo URLROOT; ?>/consultants/register" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-input-title">NIC Number</div>
          <input type="text" name="nic_no" placeholder="Enter your NIC number" value="<?php echo $data['nic_no']; ?>">
          <span class="form-invalid"><?php echo $data['nic_no_err']; ?></span>
