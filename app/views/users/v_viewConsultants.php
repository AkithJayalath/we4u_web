...
<div class="cargivers-container">
  <div class="caregivers-wrapper">
    ...
    <input type="date" id="date-filter" name="date" value="" placeholder="Any date" />


      <label for="type-filter">Speciality:</label>
      <select id="type-filter" name="type">
        <option value="">Any</option>
        <option value="Short Term">Cardiologist</option>
        <option value="Long Term">Surgen</option>
      </select>
