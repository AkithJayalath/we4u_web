        ...
        <form id="editprofileForm" action="<?php echo URLROOT; ?>/caregivers/editmyProfile" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-fields">
                ...
                <div class="form-group">
                    ...
                    <textarea name="specialty" id="specializations" cols="30" rows="5" placeholder="Enter your specializations or experiences"><?php echo $data['specialty']; ?></textarea>
                </div>

                <div class="form-group">
                    <label>Available Regions</label>
                    <textarea name="available_region" id="available_regions" cols="30" rows="5"><?php echo $data['available_region']; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="select-wrapper">
                        <button class="dropbtn">Select Skills</button>
                ...
                <script>
                    ...
                    //call function to show saved skills
