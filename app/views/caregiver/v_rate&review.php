...
<page-body-container>
    ...
    <div class="container">
        <div class="header">
            ...
            <button class="add-review-btn" onclick="window.location.href='<?php echo URLROOT; ?>/caregiver/addReview'">
        ...
        <div class="review">
            ...
            <?php else: ?>
                <?php foreach ($data['reviews'] as $review): ?>
                    <div class="review-card" onclick="window.location.href='<?php echo URLROOT; ?>/careseeker/editReview/<?php echo $review->review_id; ?>'" style="cursor: pointer;">
